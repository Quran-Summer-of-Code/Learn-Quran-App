...
const ScrollBarView = ({ children, styles, width = 6 }: any) => {
  const isWeb = Platform.OS === "web";
  return (
    <>
      {isWeb && (
        <ScrollView contentContainerStyle={styles.containerStyle} style={styles.scrollViewWrapper}>{children}</ScrollView>
      )}
      {!isWeb && (
