...
هذا المستند يحتوي علي بعض الأفكار لتطبيقات خطرت علي ذهني خلال أو قبل عملي علي برنامج تعلم وتدبر القرآن ومُرحب تماماً أن تضيف أفكار أخري أو تحسينات علي الأفكار الحالية أو أن تبدأ في العمل، المساهمة أو الإشراف علي أيٍ منها (بعد الإشارة طبعاً). علي عكس GSoC، نسبة القبول في QSoC تقارب المئة بالمئة والأجر يكون من عند الله تعالي.
...
>  📝 ملحوظة: لقد تقدم شخص أو أكثر للعمل علي هذه الفكرة ولكن لا مانع لهم أن تتقدم انت أيضاً للمساهمة.
> 
## 🎯 نبذة
...
## 🎓 المنتور
[م/محمد سلامة وم/عصام وسام](https://github.com/EssamWisam/Learn-Quran-App/issues/7)
## 👨🏻‍💻 المساهمين
[م/محمد سلامة وم/عصام وسام](https://github.com/EssamWisam/Learn-Quran-App/issues/7)
...
>  📝 ملحوظة: لقد تقدم شخص للعمل علي هذه الفكرة ولكن لا مانع له أن تتقدم انت أيضاً للمساهمة.
...
#  6️⃣ تطبيق لتسهيل الحفظ 

## 🎯 نبذة
أغلب التطبيقات الموجودة حالياً تركز علي تكرار سلاسل الآيات لتيسير الحفظ، هل من الممكن إضافة علي ذلك سبل أخري لتيسير الحفظ وربط ذلك مع فهم المعاني ومواضيع السور؟
## ✅ المتطلبات المتوقعة

- أولاً تيسير الحفظ عن طريق تكرار سماع سلاسل الآيات كما يحدد المستخدم أو باستخدام التبويب الموضوعي للآيات كما في التفسير المنير
- مع القدرة علي القراءة وبهذا يستخدم الحفظ البصر والسمع (والتبويب الموضوعي يساعد علي الفهم)
- إضافة القدرة علي تسجيل تسميع الآيات والمقارنة مع القارئ الشيخ
  - أما أن يترك التقييم للمستخدم عن طريق سماع التسميع ومقارنته مع التلاوة أو تشغيل كلاهما في ذات الوقت
  - إذا سمح الوقت يمكن اللجوء للذكاء الاصطناعي ولكن بشرط أن لا يُستخدم التعلم العميق (ذكر مطوري تطبيق ترتيل أن هذا ما دعاهم لجعل الخدمة مدفوعة)
  - بهذا يستخدم الحفظ نعم البصر والسمع والكلام
  - بعد التسجيل يمكن تغيير تردد وصدي الصوت اوتوماتيكياً حتي تقترب جودته من تسجيلات القراء الشيوخ (لتحفيذ المستخدم علي الاستمرار فمع الختمة يكون قد سجل القرآن كاملاً بجودة جيدة جداً ويمكنه الرجوع إلي التسجيل في وقت لاحق لاسترجاع الحفظ)
- إضافة القدرة علي التسميع من خلال اللمس عن طريق اختيار الكلمة التالية الصحيحة للآية (هذا اسهل من الكتابة) وبهذا يستخدم الحفظ أيضاً نعمة اللمس 
- دمج اختبارات التسميع مع المعاني من كتاب غريب القرآن لربط الحفظ مع فهم المعاني (يمكن الربط مع أحد التفاسير اليسيرة ايضاً كالمختصر)
- كلاً من تعدد الحواس والفهم يساعدون في تيسير الحفظ ولكن التطبيقات المتاحة أما لا تربطه مع الفهم أو لا تستخدم كل الحواس الممكنة

يمكن أن يسمي البرنامج Quranlingo وأن يكون به تسلل منطقي للحفظ والفهم واختباراته.
## 🎓 المنتور
لم يحدد بعد
## 👨🏻‍💻 المساهمين
لم يحدد بعد 
...
## 🎓 المنتور
[م/عصام وسام](https://github.com/EssamWisam/Learn-Quran-App/issues/3) ولكن قد يتغير ذلك.
## 👨🏻‍💻 المساهمين
[م/احمد ياسر](https://github.com/EssamWisam/Learn-Quran-App/issues/3).
...
اما أذا اردت أن تكون منتور فالأسهل هو التواصل المباشر، مثلاً عبر [البريد الإلكتروني](mailto:essamwisam@outlook.com) أو [لينكدن](https://www.linkedin.com/in/essamwisam/).
